...
import dotenv from "dotenv"; // Importe dotenv para carregar variáveis de ambiente do arquivo .env

dotenv.config(); // Carrega variáveis de ambiente do arquivo .env

const { PGUSER, PGPASSWORD, PGHOST, PGPORT, PGDATABASE } = process.env; // Obtém as variáveis de ambiente
